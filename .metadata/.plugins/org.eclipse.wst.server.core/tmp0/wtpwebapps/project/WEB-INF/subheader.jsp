            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item"><a class="nav-link js-scroll-trigger" href="#projects">서브헤더</a></li>
                        <li class="nav-item"><a class="nav-link js-scroll-trigger" href="#signup">서브헤더만들자</a></li>
                    </ul>
                </div>
            </div>
        </nav>