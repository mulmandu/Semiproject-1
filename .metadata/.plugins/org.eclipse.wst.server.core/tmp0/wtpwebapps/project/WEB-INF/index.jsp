...
<header class="masthead">
	<div class="container d-flex h-100 align-items-center">
		<div class="mx-auto text-center">
			<h1 class="mx-auto my-0 text-uppercase" id="title">
				<img style="width: 100px; height: 100px;"
					src="assets/img/copyright.jpg"><span class="logotext typer">Grayscale</span>
			</h1>
			<h3 class="text-white-50 mx-auto mt-2 mb-5">
				ProjectName 은 한발 앞서가는 분석으로 <br>최적의 매물과 가치를 만들어 드립니다.
			</h3>
			<a class="btn btn-primary js-scroll-trigger" href="#signup">Get
				Started</a>
...
<section class="contact-section bg-black">
	<div class="container">
		<div class="row">
			<div class="col-md-4 mb-3 mb-md-0">
				<div class="card py-4 h-100">
					<div class="card-body text-center">
						<a href="hyundoo.Project?page=commercial&subcode=0"> <i
							class="fas fa-map-marked-alt text-primary mb-2"></i>
			...
			<div class="col-md-4 mb-3 mb-md-0">
				<div class="card py-4 h-100">
					<a href="semi.Project?page=estate">
						<div class="card-body text-center">
